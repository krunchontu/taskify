...
- Scheduling aids: due dates and reminders (desktop notifications) with clear display of upcoming times and one-time delivery per reminder.
...
- Reminders prompt once when the browser allows notifications; blocked/unsupported cases surface to the user.
